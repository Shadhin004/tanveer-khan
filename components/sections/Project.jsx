												...
												projectData.map((project) => (
													<SwiperSlide key={project.id}>
														<div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
															...
															<img className="w-100" src={project.projectImage} alt="zelio" />
														</div>
														<div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
															...
															<ul className="mt-4 list-unstyled">
																...
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Organization</p>
																		<p className="text-300 mb-0 text-end">{project.organization}</p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Location</p>
																		<p className="text-300 mb-0 text-end">{project.location}</p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
															...
															<div className="d-flex flex-wrap align-items-center gap-3 mt-7">
																<Link href={project.liveDemo} target='_blank' className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
																...
																<Link href={project.githubLink} target='_blank' className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
